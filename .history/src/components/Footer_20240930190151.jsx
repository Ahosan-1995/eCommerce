          ...
          <div ="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul ="text-gray-500 dark:text-gray-400 font-medium">
                <li ="mb-4">
                  <a href="https://flowbite.com/" ="hover:underline">
                    Flowbite
                  </a>
                </li>
                <li>
                  <a href="https://tailwindcss.com/" ="hover:underline">
                    Tailwind CSS
                  </a>
                </li>
              </ul>
        ...
        <div ="sm:flex sm:items-center sm:justify-between">
          ...
          <div ="flex mt-4 sm:justify-center sm:mt-0">
            ...
            >
              ...
              <span ="sr-only">Facebook page</span>
            </a>
            <a
              href="#"
            ...
            >
              ...
              <span ="sr-only">Discord community</span>
            </a>
            <a
              href="#"
              ="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5"
            >
              ...
              <span ="sr-only">Twitter page</span>
            </a>
            <a
              href="#"
              ="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5"
