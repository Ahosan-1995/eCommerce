        ...
        <div>
          <div className="py-3">
            ...
            <input
              ...
              name="date"
              id="001"
              className="border p-3 w-"
            />
          </div>
          <div className="py-3">
            <p className="mb-2">TIME</p>
            <select name="" className="border p-3  w-48">
              <option>11 AM</option>
              <option>12 PM</option>
              <option>1 PM</option>
              <option>2 PM</option>
          ...
          <div className="py-3">
            ...
            <input type="number" className="border p-3  w-48"/>
          </div>
          <div className="py-3">
            <p className="mb-2">YOUR NAME</p>
            <input
              type="text"
              className="border p-3 w-48"
            />
          </div>
          <div className="py-3">
