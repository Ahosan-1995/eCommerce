  ...
  return (
    <div>
      ...
      <div>
        ...
        <p>Make a reservation at Bouffe and secure your spot for an unforgettable dining experience. Whether it’s an intimate dinner, a special occasion, or a gathering with loved ones, our attentive team will ensure every detail is taken care of.</p>
      </div>
    </div>
  );
};
