  ...
  return (
    <div>
      ...
      <div>
        ...
        <p>Make a reservation at Bouffe and secure your spot for an unforgettable dining <br />experience. Whether it is an intimate dinner, a special occasion, or a gathering with loved <br />ones, our attentive team will ensure every detail is taken care of.</p>
        </div>
      </div>
    </div>
  );
