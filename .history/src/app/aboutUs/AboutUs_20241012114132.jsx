        ...
        <div className="flex flex-col mb-40 mt-5 px-40 ">
          ...
          <div className="mt-20">
            ...
            <div className="grid grid-cols-4 text-center text-black">
                ...
                <br />
                <Link className="text-yellow-700 font-bold text-xs" href="https://www.google.com.bd/maps/@23.7850153,90.4173249,19z?entry=ttu&g_ep=EgoyMDI0MTAwOS4wIKXMDSoASAFQAw%3D%3D">GET DIRECTION</Link>
                </p>
