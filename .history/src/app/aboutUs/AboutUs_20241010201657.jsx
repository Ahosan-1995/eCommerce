...
const AboutUs = () => {
  return (
    <div>
      <div className="flex flex-col mb-400 mt-5 px-10 ">
        ...
        <div>
            <div className="relative">
                ...
                <p className="absolute right-20">In a world where the long- and short-term effects of climate change pose major <br /> challenges for farmers, the need for regenerative food systems has never been more <br />important. Thats why we have made a promise to do more for the planet, by taking less. <br /> Our plant-forward menu means that we are already on average 30% less carbon <br /> intensive than the average American meal.</p>
            </div>
            <p></p>
        </div>
      </div>
