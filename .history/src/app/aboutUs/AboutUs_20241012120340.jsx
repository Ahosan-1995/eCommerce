    ...
    <ParallaxProvider>
      <div>
        <div className="flex flex-col mb-40 mt-5 px-40 ">
          ...
          <div className="flex text-black border shadow-xl rounded-2xl">
              ...
              <Parallax speed={20}>
                <div className="card shadow-lg h-96 p-10">
                  ...
                  <p className="text-5xl font-black mb-5">
                    <span className="bg-[#fba465] text-white">OUR</span>STORY
                  </p>
          ...
          {/* Our Locations */}
          <div className="mt-20">
            <p className="text-center text-3xl font-bold mb-5">Our Branches</p>
            <div className="grid grid-cols-4 text-center text-black">
                <p className=" rounded-md p-5"><span className="font-medium text-xl">Dhaka</span> <br /><span>House-15 <br />Rd no. 17, Block- C, <br />Gulshan</span>
                <br />
                <Link className="text-yellow-700 font-bold text-sm" href="https://www.google.com.bd/maps/@23.7850153,90.4173249,19z?entry=ttu&g_ep=EgoyMDI0MTAwOS4wIKXMDSoASAFQAw%3D%3D">GET DIRECTION</Link>
                </p>
                <p className=" rounded-md p-5 "><span className="font-medium text-xl">Dhaka</span> <br /><span>House-15 <br />Rd no. 17, Block- C, <br />Banani</span><br />
                <Link className="text-yellow-700 font-bold text-sm" href="https://www.google.com.bd/maps/@23.7850153,90.4173249,19z?entry=ttu&g_ep=EgoyMDI0MTAwOS4wIKXMDSoASAFQAw%3D%3D">GET DIRECTION</Link></p>
                <p className=" rounded-md p-5"><span className="font-medium text-xl">Rangpur</span> <br /><span>House-15 <br />Rd no. 17, Block- C, <br />Gulshan</span><br />
                <Link className="text-yellow-700 font-bold text-sm" href="https://www.google.com.bd/maps/@23.7850153,90.4173249,19z?entry=ttu&g_ep=EgoyMDI0MTAwOS4wIKXMDSoASAFQAw%3D%3D">GET DIRECTION</Link></p>
                <p className=" rounded-md p-5"><span className="font-medium text-xl">Rajshahi</span> <br /><span>House-15 <br />Rd no. 17, Block- C, <br />Gulshan</span><br />
                <Link className="text-yellow-700 font-bold text-sm" href="https://www.google.com.bd/maps/@23.7850153,90.4173249,19z?entry=ttu&g_ep=EgoyMDI0MTAwOS4wIKXMDSoASAFQAw%3D%3D">GET DIRECTION</Link></p>
                <p className=" rounded-md p-5"><span className="font-medium text-xl">Chittagong</span> <br /><span>House-15 <br />Rd no. 17, Block- C, <br />Gulshan</span><br />
                <Link className="text-yellow-700 font-bold text-sm" href="https://www.google.com.bd/maps/@23.7850153,90.4173249,19z?entry=ttu&g_ep=EgoyMDI0MTAwOS4wIKXMDSoASAFQAw%3D%3D">GET DIRECTION</Link></p>
                <p className=" rounded-md p-5"><span className="font-medium text-xl">Barishal</span> <br /><span>House-15 <br />Rd no. 17, Block- C, <br />Gulshan</span><br />
                <Link className="text-yellow-700 font-bold text-sm" href="https://www.google.com.bd/maps/@23.7850153,90.4173249,19z?entry=ttu&g_ep=EgoyMDI0MTAwOS4wIKXMDSoASAFQAw%3D%3D">GET DIRECTION</Link></p>
                <p className=" rounded-md p-5"><span className="font-medium text-xl">Dhaka</span> <br /><span>House-15 <br />Rd no. 17, Block- C, <br />Khulna</span><br />
                <Link className="text-yellow-700 font-bold text-sm" href="https://www.google.com.bd/maps/@23.7850153,90.4173249,19z?entry=ttu&g_ep=EgoyMDI0MTAwOS4wIKXMDSoASAFQAw%3D%3D">GET DIRECTION</Link></p>
                <p className=" rounded-md p-5"><span className="font-medium text-xl">Noakhali</span> <br /><span>House-15 <br />Rd no. 17, Block- C, <br />Gulshan</span><br />
                <Link className="text-yellow-700 font-bold text-sm" href="https://www.google.com.bd/maps/@23.7850153,90.4173249,19z?entry=ttu&g_ep=EgoyMDI0MTAwOS4wIKXMDSoASAFQAw%3D%3D">GET DIRECTION</Link></p>
