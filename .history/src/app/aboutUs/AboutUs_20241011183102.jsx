    ...
    <ParallaxProvider>
      <div>
        <div className="flex flex-col mb-40 mt-5 px-40 ">
          ...
          <div className="mt-20">
            <p>Our Branches</p>
            <div className="grid grid-cols-3 gap-3 text-center content-center">
                ...
                <p className="bg-green-300 rounded-md p-2"><span className="font-medium text-xl">Dhaka</span> <br /><span>House-15 <br />Rd no. 17, Block- C, <br />Banani</span></p>
