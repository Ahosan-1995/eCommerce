        ...
        <div className="flex flex-col mb-40 mt-5 px-40 ">
          ...
          <div className="mt-20">
            ...
            <div className="grid grid-cols-3 gap-3 text-center ">
                ...
                <p className="bg-green-300 rounded-md p-2 text content-center items-center"><span className="font-medium text-xl">Dhaka</span> <br /><span>House-15 <br />Rd no. 17, Block- C, <br />Banani</span></p>
