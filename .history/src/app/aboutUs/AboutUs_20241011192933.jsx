    ...
    <ParallaxProvider>
      <div>
        <div className="flex flex-col mb-40 mt-5 px-40 ">
          ...
          <div className="flex text-white bg-[#001f3f] rounded-2xl">
          ...
          <div className="mt-20">
            ...
            <div className="grid grid-cols-3 gap-3 text-center text-black">
                <p className="border-sm border-black rounded-md p-5"><span className="font-medium text-xl">Dhaka</span> <br /><span>House-15 <br />Rd no. 17, Block- C, <br />Gulshan</span></p>
                <p className="border-sm border-black rounded-md p-5 "><span className="font-medium text-xl">Dhaka</span> <br /><span>House-15 <br />Rd no. 17, Block- C, <br />Banani</span></p>
                <p className="border-sm border-black rounded-md p-5"><span className="font-medium text-xl">Dhaka</span> <br /><span>House-15 <br />Rd no. 17, Block- C, <br />Baridhara</span></p>
                <p className="border-sm border-black rounded-md p-5"><span className="font-medium text-xl">Rangpur</span> <br /><span>House-15 <br />Rd no. 17, Block- C, <br />Gulshan</span></p>
                <p className="border-sm border-black rounded-md p-5"><span className="font-medium text-xl">Rajshahi</span> <br /><span>House-15 <br />Rd no. 17, Block- C, <br />Gulshan</span></p>
                <p className="border-sm border-black rounded-md p-5"><span className="font-medium text-xl">Chittagong</span> <br /><span>House-15 <br />Rd no. 17, Block- C, <br />Gulshan</span></p>
                <p className="border-sm border-black rounded-md p-5"><span className="font-medium text-xl">Barishal</span> <br /><span>House-15 <br />Rd no. 17, Block- C, <br />Gulshan</span></p>
                <p className="border-sm border-black rounded-md p-5"><span className="font-medium text-xl">Dhaka</span> <br /><span>House-15 <br />Rd no. 17, Block- C, <br />Khulna</span></p>
                <p className="border-sm border-black rounded-md p-5"><span className="font-medium text-xl">Noakhali</span> <br /><span>House-15 <br />Rd no. 17, Block- C, <br />Gulshan</span></p>
