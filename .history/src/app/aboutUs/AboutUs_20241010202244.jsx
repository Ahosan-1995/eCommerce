...
const AboutUs = () => {
  ...
  <div className="relative">
    <p className="mb-4">
      Immerse yourself in an experience that <br /> transcends the ordinary
    </p>
    <p className="absolute right-0 top-0 w-[60%] text-gray-700 leading-relaxed">
      In a world where the long- and short-term effects of climate change pose major <br />
      challenges for farmers, the need for regenerative food systems has never been more <br />
      important. That's why we have made a promise to do more for the planet, by taking less. <br />
      Our plant-forward menu means that we are already on average 30% less carbon <br />
