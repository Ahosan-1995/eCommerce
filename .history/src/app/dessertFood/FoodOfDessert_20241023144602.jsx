...
const FoodOfDessert = async () => {
  const { menu } = (await getMenus()) || {};


  return (
    <div>
      <div className="bg-[url('https://i.postimg.cc/vHcWBXPc/dessert-8.jpg')] h-[500px] bg-cover px-10 flex flex-col  text-center justify-center mt-10 ">
