...
const getMenus = async () => {
    try {
        ...
        let filtes = menus.filter(menu => menu.category === 'Bangladeshi Food');
...
const Bfood = () => {
  return (
    <div className="mx-auto px-40">
      ...
      <div key={filte._id} className="card  shadow-xl ">
        <div className="flex flex-col justify-center items-center content-center">
          ...
          <div className="card-body items-center text-center">
            <h2 className="text-xl font-bold">{filte.name}</h2>
            <p>{filte.description}</p>
