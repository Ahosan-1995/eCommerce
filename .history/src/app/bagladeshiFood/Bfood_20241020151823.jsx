...
const Bfood = () => {
  return (
    <div className="mx-auto px-40">
      ...
      <div key={filteredMenus._id} className="card  shadow-xl ">
        <div className="flex flex-col justify-center items-center content-center">
          <figure className="px-5 pt-5 ">
            <Image
              src={filteredMenus.image}
              alt="Logo"
              width={400}
              height={200}
