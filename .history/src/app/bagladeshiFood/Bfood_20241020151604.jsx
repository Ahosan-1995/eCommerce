...
const getMenus = async () => {
    try {
        ...
        // Filter the menus by the category 'bangladeshifood'
        let filteredMenus = menus.filter(menu => menu.category === 'bangladeshifood');
...
const Bfood = () => {
  return (
    <div className="mx-auto px-40">
      ...
      <div key={filteredMenu._id} className="card  shadow-xl ">
        <div className="flex flex-col justify-center items-center content-center">
          ...
          <div className="card-body items-center text-center">
            <h2 className="text-xl font-bold">{filteredMenu.name}</h2>
            <p>{filteredMenu.description}</p>
