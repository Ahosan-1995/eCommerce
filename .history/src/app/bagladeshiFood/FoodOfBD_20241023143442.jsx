...
const FoodOfBD = async() => {
  ...
  return (
    <div>
      ...
      {
        menu.map(menu=>menu.category==="Bangladeshi Food"?<div key={sMenu._id} className="card  shadow-xl ">
          <div className="flex flex-col justify-center items-center content-center">
            ...
            <div className="card-body items-center text-center">
              ...
              <div className=" mt-5  flex lg:flex-row justify-between w-full">
                <button className="btn bg-[#001f3f] text-white hover:text-black" >Price: {sMenu.price}</button>
