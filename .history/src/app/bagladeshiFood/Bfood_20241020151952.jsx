...
const Bfood = () => {
  return (
    <div className="mx-auto px-40">
      ...
      {
        getMenus.map(menu=><div key={getMenus._id} className="card  shadow-xl ">
