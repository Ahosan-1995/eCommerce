        ...
        <div className="shadow-2xl p-10">
          <div className="text-center mt-10 ">
            ...
            <p>
              ...
              experience. Whether it is an intimate dinner, a special occasion,
              or a gathering with loved <br />
              ones, our attentive team will ensure every detail is taken care
              of.
            </p>
          </div>
          <div className="mt-10 mb-20">
            <div className="flex-row md:flex-row sm:flex-row lg:flex justify-between">
              <div className="">
