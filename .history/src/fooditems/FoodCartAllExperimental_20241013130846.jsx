...
const FoodCartAllExperimental = ({ menu, name }) => {
  ...
  return (
    <div className="py-5">
      ...
      <br />
      <hr></hr>
      <div className="grid grid-cols-1 md:grid-cols-2  lg:grid-cols-3 gap-5 px-40">
        {menu && menu.length > 0 ? (
          menu.map((sMenu) => (
            <div key={sMenu._id} className="card  shadow-xl ">
              <div className="flex flex-col justify-center items-center content-center">
                ...
                <div className="card-body items-center text-center">
                  ...
                  <div className=" mt-5 items-center flex lg:flex-row lg:justify-between w-full">
                    <p className="bg-[#001f3f] text-white rounded-md p-2 py-[11px] px-4">Price: <span>{sMenu.price}</span></p>
                    <button className="btn bg-[#001f3f] text-white hover:text-black">View Details</button>
                  </div>
                </div>
              </div>
            </div>
