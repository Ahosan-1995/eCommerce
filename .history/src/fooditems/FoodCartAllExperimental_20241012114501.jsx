  ...
  return (
    <div className="py-5">
      <div className="flex h-60">
        <div className="w-full rounded-br-lg  bg-yellow-700 text-center content-center text-3xl font-bold text-white">{name}</div>
        <div className="w-full rounded-bl-lg  bg-[#001f3f] bg-yellow-700"></div>
      </div>
      <br />
      <hr></hr>
