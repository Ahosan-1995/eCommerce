  ...
  return (
    <div className="px-40 py-5">
      <div className="flex h-60">
        <div className="w-full rounded-br-lg  bg-black text-center content-center items-center text-3xl font-bold">{name}</div>
        <div className="w-full rounded-bl-lg  bg-black"></div>
      </div>
